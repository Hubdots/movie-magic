...
const movieSchema = new Schema({
    title: {
        ...
        minLength: [5, 'Title should be at least 5 charaters long!'],
        maxLength: 250,
    ...
    genre: {
        ...
        minLength: [5, 'Genre should be at least 5 charaters long!'],
        maxLength: 250,
    ...
    director: {
        ...
        minLength: [5, 'Director should be at least 5 charaters long!'],
        maxLength: 250,
